...
module.exports = {
    processPurchase: purchaseControllerInstance.processPurchase.bind(purchaseControllerInstance),
    getAllPurchases: purchaseControllerInstance.getPurchases.bind(purchaseControllerInstance),
    getPurchasesByClientId: purchaseControllerInstance.getPurchasesByClient.bind(purchaseControllerInstance)
};